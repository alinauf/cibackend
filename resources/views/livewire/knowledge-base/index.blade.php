    ...
    <div class="px-4 sm:px-6 lg:px-8">
        <div class="sm:flex sm:items-center">
            <div class="sm:flex-auto">
                <h1 class="text-base font-semibold leading-6 text-gray-900">Knowledge Base</h1>
                <p class="mt-2 text-sm text-gray-700">A list of all questions and answers gathered</p>
            ...
            <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                <a href="{{url("knowledge-base/create")}}"
                            ...
                            @foreach($knowledgeBases as $knowledgeBase)
                                ...
                                <tr>
                                    ...
                                    <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                                        <a href="{{url("knowledge-base/".$knowledgeBase["id"])}}"
