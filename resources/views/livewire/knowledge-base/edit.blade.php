...
>
    ...
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __("Update the details of the question and answers") }}
        </p>
    </header>

    <form action="{{url("knowledge-base/$knowledgeBase->id")}}" method="POST">
        @method('PUT')
        @csrf
        ...
        <x-confirm-create-modal title="Are you sure"
                                subtitle="Please confirm if you would like to update the knowledge base"/>
    </form>
</div>
